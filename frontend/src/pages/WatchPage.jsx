...
import { ORIGINAL_IMG_BASE_URL, SMALL_IMG_BASE_URL } from "../utils/constans";
      ...
      <div className="mx-auto container px-4 py-8 h-full">
        ...
        {trailers.length > 0 && (
          <div className="flex justify-between items-center mb-4">
            <button
              className={`
                bg-gray-500/70 hover:bg-gray-500 text-white py2 px-4 rounded ${
        ...
        <div className="aspect-video mb-8 p-4 sm:px-10 md:px-32">
          {trailers.length > 0 && (
            <ReactPlayer
              controls={true}
              width={"100%"}
